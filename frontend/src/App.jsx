      ...
      {createPortal(
        <div
          ...
          style={{
            ...
            left: 0,
            top: 0,
            width: isHoveringBirdButton && !hasResult ? ((isListening && recordingStartTime && Date.now() - recordingStartTime >= 6000) ? '60px' : (isListening ? '16px' : '50px')) : (isHoveringBookmark ? '32px' : '16px'),
            height: isHoveringBirdButton && !hasResult ? ((isListening && recordingStartTime && Date.now() - recordingStartTime >= 6000) ? '28px' : (isListening ? '16px' : '28px')) : (isHoveringBookmark ? '32px' : '16px'),
            borderRadius: isHoveringBirdButton && !hasResult ? ((isListening && recordingStartTime && Date.now() - recordingStartTime >= 6000) ? '100px' : (isListening ? '50%' : '100px')) : '50%',
            backgroundColor: isHoveringBirdButton && !hasResult ? '#D8B5FE' : (isHoveringBookmark ? '#1DB954' : (isHoveringInteractive ? '#D8B5FE' : '#FFFFFF')),
            pointerEvents: 'none',
            ...
            padding: isHoveringBirdButton && !hasResult ? ((isListening && recordingStartTime && Date.now() - recordingStartTime >= 6000) ? '8px 10px' : (isListening ? '0' : '8px 10px')) : '0',
            fontSize: isHoveringBirdButton && !hasResult ? ((isListening && recordingStartTime && Date.now() - recordingStartTime >= 6000) ? '14px' : (isListening ? '0' : '14px')) : '0',
        ...
        >
          <span style={{ 
            ...
            left: '50%',
            transform: 'translate(-50%, -50%)',
            opacity: isHoveringBirdButton && !hasResult ? ((isListening && recordingStartTime && Date.now() - recordingStartTime >= 6000) ? 1 : (isListening ? 0 : 1)) : 0,
