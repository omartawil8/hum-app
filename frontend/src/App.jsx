                  ...
                  >
                    ...
                    <div className={`relative rounded-2xl p-4 border-2 transition-all duration-300 ${
                      ...
                      {userTier === 'avid' && billingPeriod === 'monthly' && (
                        <div className="absolute top-1 left-1/2 -translate-x-1/2 px-3 py-0.5 rounded-full bg-white/10 border border-white/25 text-[10px] font-semibold uppercase tracking-wide text-white/70 backdrop-blur-md z-20">
                          current plan
                        </div>
                      )}
                      {/* Star badge */}
